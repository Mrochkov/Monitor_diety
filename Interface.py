...
def Okno_dane(dzienne_zapotrzebowanie, lista_preferencji, dane, liczba_wszystkich):
    ...
    aktywnosc.set(1)
    label1_0 = Label(frame1, text="Jak zazwyczaj wygląda twoja aktywność fizyczna w ciągu tygodnia?", fg = 'blue')
...
def Okno_spozycie(dzienne_zapotrzebowanie, dzienna_suma):
    ...
    # PODPISY FRAME 2
    label6 = tk.Label(frame2, text="Dzienne zapotrzebowanie: ", fg='blue')
    label6.grid(row=0, column=0, padx=5, pady=5, sticky='NW')
    ...
    label7 = tk.Label(frame2, text="Spożyto dzisiaj: ", fg= 'blue')
    label7.grid(row=5, column=0, padx=5, pady=5, sticky= 'NW')
...
def Okno_lista(dane, lista_preferencji, liczba_wszystkich, dzienna_suma):
    ...
    # FRAME 3
    frame3 = LabelFrame(frame_gl, text="Lista przepisów", fg= 'blue')
...
def Okno_podsumowanie(dzienne_zapotrzebowanie, dzienna_suma):
    ...
    frame4 = LabelFrame(frame_gl, text="Podsumowanie dnia", fg ='blue')
    frame4.grid(row=0, column=0, padx=5, pady=5)

    label_p1 = Label(frame4, text="Kalorie: " + lista[0])
    label_p1.grid(row=0, column=0, padx=5, pady=5, sticky='NW')
    label_p2 = Label(frame4, text="Białka: " + lista[1])
    label_p2.grid(row=1, column=0, padx=5, pady=5,sticky=' NW')
    label_p3 = Label(frame4, text="Tłuszcze: " + lista[2])
    label_p3.grid(row=2, column=0, padx=5, pady=5, sticky='NW')
    label_p4 = Label(frame4, text="Węglowodany: " + lista[3])
    label_p4.grid(row=3, column=0, padx=5, pady=5, sticky= 'NW')
